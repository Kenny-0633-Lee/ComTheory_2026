...
\begin{frame}{Definitions: Signals and Systems}
    ...
    \small{
    \begin{itemize}
        \item A signal is a set of information or data.
        \item Examples: Audio signals, video signals, sensor data, etc.
        \item In all these examples, the signals are functions of the independent variable \textbf{time $t$}.
    \end{itemize}}
    %  \vspace{0.2cm}
    \fbox{Systems}
    \small{
    \begin{itemize}
        \item Signals may be processed further by systems, which may modify them or extract additional infromation from them.
        ...
        \item Thus, a system is an entity that processes signals (\textbf{inputs}) to yield another set of signals (\textbf{outputs}).
    ...
    \begin{columns}
        ...
        \begin{column}{0.55\textwidth}
            ...
            \begin{block}{Power Signal}
                ...
                \[
                P = \lim_{T \to \infty} \frac{1}{T} \int_{-T}^{T} |x(t)|^2 dt < \infty, \quad E = \infty
                \]
            \end{block}
        \end{column}
    \end{columns} 
