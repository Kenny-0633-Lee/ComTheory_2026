...
\xmybox[green]{\small\textbf{Q. Determine the suitable measures of the signals in \cref{fig:2.2}.}}
    \begin{columns}[c]
    % [왼쪽 컬럼] 그림 (a), (b)
...
\begin{columns}[b] % [b]: 하단 정렬
    \begin{column}{0.45\textwidth}
    \incfig{fig_ch02_05}{1.0}{Periodic signal of period $T_0$}{fig:2.5}
    \end{column}
    ...
    \begin{column}{0.5\textwidth}
        ...
        \begin{tcolorbox}[enhanced,title=\cref{fig:2.5}, frame style={left color=red!75!black, right color=blue!75!black}]
            \begin{itemize}
                \item A signal $g(t)$ is \textbf{periodic} if there exists a positive constant $T_0$.
                \item The smallest value of $T_0$ in Eq. (\theequation) is the \textbf{period} of $g(t)$.
            \end{itemize}
            %\tcblower
...
\begin{frame}[fragile]
    ...
    \begin{columns}
        ...
        \begin{column}{0.45\textwidth}
            ...
            \fakecaption{fig:2.1}{Energy vs Power Signals (Recap)}
        \end{column}
...
\begin{frame}[fragile]
\frametitle{Figure 2.6 Time shifting a signal}
\centering

\begin{columns}[T] % [b]: 하단 정렬
    \begin{column}{0.45\textwidth}
    \incfig{fig_ch02_06}{0.8}{Time shifting a signal}{fig:2.6}
    \end{column}
...
\begin{frame}[fragile]
\frametitle{Figure 2.7 Time scaling a signal}
\centering

\begin{columns}[T] % [b]: 하단 정렬
    \begin{column}{0.45\textwidth}
    \incfig{fig_ch02_07}{0.8}{Time scaling a signal}{fig:2.7}
    \end{column}
